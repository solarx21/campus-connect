...
const userSchema = new mongoose_1.Schema({
    ...
    coolVotes: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }],
    admirers: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }],
    admiredUsers: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }],
